  ...
  _createClass(TextFit, [{
    ...
    value: function process() {
      ...
      var _props = this.props,
          ...
          titleQuotient = _props.titleQuotient,
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          titleQuotient = _props2.titleQuotient,
          props = _objectWithoutProperties(_props2, ['children', 'text', 'style', 'min', 'max', 'mode', 'forceWidth', 'forceSingleModeWidth', 'throttle', 'autoResize', 'onReady', 'titleQuotient']);
...
TextFit.propTypes = {
  ...
  titleQuotient: _propTypes2.default.number
};
